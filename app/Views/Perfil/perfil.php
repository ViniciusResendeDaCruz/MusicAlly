                ...
                <div class="row">
                    <div class="form-check">
                        ...
                        <label class="form-check-label text-danger" for="defaultCheck1">
                            Tenho certeza que desejo excluir minha conta junto de todos os meus dados do sistema
                            MusicAlly
                        </label>
                    </div>
                </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col-6">
                ...
                <input name="nome" type="text" class="form-control p_input" value="<?php echo $user['nome'] ?>"
                    required>
            </div>
            <div class="form-group col-6">
                <label>Sobrenome <span class="text-danger">*</span></label>
                <input name="sobrenome" type="text" class="form-control p_input"
                    value="<?php echo $user['sobrenome'] ?>" required>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-6">
                <label>Senha <span class="text-danger">*</label>
                <input name="senha" type="password" class="form-control p_input" placeholder="Insira uma nova senha"
                    required>
            </div>
            <div class="form-group col-6">
                <label>Repita a senha <span class="text-danger">*</label>
                <input name="repeteSenha" type="password" class="form-control p_input" placeholder="Repita a nova senha"
                    required>
            </div>
        </div>
...
function excluirConta() {
    ...
    $.ajax({
        ...
        success: function(response) {
            $("#modalBody").html(
                "<div class=\"alert alert-success\">Sua conta foi excluida com sucesso! Você será redirecionado para a página de login em breve</div>"
                )
            setTimeout(function() {
